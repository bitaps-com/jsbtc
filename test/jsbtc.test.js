...
describe(`${(browser) ? 'Browser' : 'Node'} test jsbtc library`, function () {
    ...
    describe("Transactions classes:", function () {
        ...
        it('Transaction constructor', () => {
            ...
            tx.addOutput({amount: 20000, address: "37P8thrtDXb6Di5E7f4FL3bpzum3fhUvT7"});
            tx.addOutput({amount: 605558, address: "1G4PJum2iB4giFQFpQj8RqzfbKegvWEJXV"});
            ...
            tx.addOutput({amount: 3081000, address: "3BMEXxajhZYe3xijDp4R9axzJ6Avywupwk"});
            tx.addOutput({amount: 500000, address: "1HunCYemQiLVPMbqY1QdarDKPiVq2Y86aR"});
            tx.addOutput({amount: 420630, address: "3DU6k6uJBaeSJqkjTYLHixKycrfAZQQ5pP"});
            tx.addOutput({amount: 646929, address: "bc1qwqdg6squsna38e46795at95yu9atm8azzmyvckulcc7kytlcckxswvvzej"});
            ...
            tx.addOutput({amount: 420630, scriptPubKey: "a9148130201b6b9b07e34bae2f1a03ab470b1f6bddf087"});
            tx.addOutput({amount: 646929, scriptPubKey: "0020701a8d401c84fb13e6baf169d59684e17abd9fa216c8cc5b9fc63d622ff8c58d"});
            equal(tx.serialize({segwit:false, hex:true}), rawNonSegwitView);
            equal(tx.serialize({segwit:true, hex:true}), rawSegwitView);
            equal(rh2s(tx.txId), "4e3895de573305e08b09926f410836ae30e9e3e909b92beea6a4dd7eb096609e");
            equal(rh2s(tx.hash), "56a3ad9e259676b347d7a90d4cf65a3a60c29e0b49dbad0831846bcaad7d5db2");
            ...
            tx.addOutput({amount: 16760, address: "1BviYPm6tjmAU3JzK7JgW4GcG1NPDwpcJA"});
            ...
            tx.addOutput({amount: 2018213798, address: "18cBEMRxXHqzWWCxZNtU91F5sbUNKhL5PX"});
            tx.addOutput({amount:0, scriptPubKey: "6a24aa21a9edc00d472fceafe0fc49747df90d75f7324e3c83214b1a1308f3eda376848df481"});
