module.exports = function (S) {
    ...
    S.signMessage = (m, privateKey, A = {}) => {
        ...
        if (S.isString(privateKey)) {
            ...
            else if (S.isWifValid(privateKey)) privateKey = S.wifToPrivateKey(privateKey, {hex: false});
    ...
    S.publicKeyRecovery = (s, m, recId, A = {}) => {
        ...
        try {
            ...
            if (A.der) {
                ...
                r = CM._secp256k1_ecdsa_recoverable_signature_parse_compact(S.secp256k1PrecompContextSign, sCcRp, sP, recId);
    ...
    S.bitcoinMessage = function (msg) {
        return S.doubleSha256(BC([
            S.Buffer.from('\x18Bitcoin Signed Message:\n', 'utf8'),
            BF(S.intToVarInt(msg.length)),
            S.Buffer.from(msg, 'utf8')]), {hex: false});
    };
    ...
    S.signBitcoinMessage = (m, privateKey, A = {}) => {
        ...
        try {
            ...
            r = CM._secp256k1_ecdsa_sign_recoverable(S.secp256k1PrecompContextSign, sP, mP, pP, null, null);
            if (r) {
                r = CM._secp256k1_ecdsa_recoverable_signature_serialize_compact(S.secp256k1PrecompContextSign, sDp + 1,
                    sDp, sP);
                if (r) {
    ...
    S.bitcoinSignedMessageAddresses = (m, s, A = {}) => {
        ARGS(A, {testnet: false});
    ...
    S.verifyBitcoinMessage = (m, s, a, A = {}) => {
        ARGS(A, {testnet: false});
        let addresses = S.bitcoinSignedMessageAddresses(m, s, A);
